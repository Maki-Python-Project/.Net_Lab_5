...
namespace lab5
{
        ...
        public Student DeepCopy()
        {
          ...
          public bool Save(string filename)
            ...
            try
            {
                if (!File.Exists(filename)) { Console.WriteLine("The specified file does not exist, so it was created"); }
            ...
            {
                Console.WriteLine($"Error writing object to file\n{e}\n");
                return false;
            }
        ...
        {
           Console.WriteLine("Enter the subject name, grade and date of the format exam yyyy-mm-dd.\nUse the symbol as delimiters ','");
           string[] information = Console.ReadLine().Split(',', StringSplitOptions.RemoveEmptyEntries);
            ...
            {
                Console.WriteLine($"WARNING! Typing errors\n{e}\n");
                return false;
            }
        }
